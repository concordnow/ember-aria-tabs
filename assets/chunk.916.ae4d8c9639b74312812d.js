/*! For license information please see chunk.916.ae4d8c9639b74312812d.js.LICENSE.txt */
...
r.enumerable=r.enumerable||!1,r.configurable=!0,"value"in r&&(r.writable=!0),Object.defineProperty(e,r.key,r)}}function l(e,t,n){return t&&u(e.prototype,t),n&&u(e,n),e}function c(e,t){return function(e){if(Array.isArray(e))return e}(e)||function(e,t){var n=e&&("undefined"!=typeof Symbol&&e[Symbol.iterator]||e["@@iterator"])
...
break}return n}function I(e,t){return-1!==t.indexOf(e)}function M(e){var t=A("array",e)?[]:{}
for(var n in e)if(C.call(e,n)){var r=e[n]
t[n]=r===Object(r)?M(r):r}return t}function R(e,t,n){for(var r in t)C.call(t,r)&&(void 0===t[r]?delete e[r]:n&&void 0!==e[r]||(e[r]=t[r]))
...
return n.pop(),a}return"string"===o?i:"[ERROR: Missing QUnit.dump formatter for type "+t+"]"},typeOf:function(e){return null===e?"null":void 0===e?"undefined":A("regexp",e)?"regexp":A("date",e)?"date":A("function",e)?"function":void 0!==e.setInterval&&void 0!==e.document&&void 0===e.nodeType?"window":9===e.nodeType?"document":e.nodeType?"node":function(e){return"[object Array]"===T.call(e)||"number"==typeof e.length&&void 0!==e.item&&(e.length?e.item(0)===e[0]:null===e.item(0)&&void 0===e[0])}(e)?"array":e.constructor===Error.prototype.constructor?"error":s(e)},separator:function(){return this.multiline?this.HTML?"<br />":"\n":this.HTML?"&#160;":" "},indent:function(e){if(!this.multiline)return""
...
function Q(e,t,n){var r=H.length?H.slice(-1)[0]:null,i=null!==r?[r.name,e].join(" > "):e,o=r?r.suiteReport:ze,s=null!==r&&r.skip||n.skip,a=null!==r&&r.todo||n.todo,u={name:i,parentModule:r,tests:[],moduleId:O(i),testsRun:0,testsIgnored:0,childModules:[],suiteReport:new B(e,o),skip:s,todo:!s&&a,ignored:n.ignored||!1},l={}
...
z(e,t,n,{ignored:$&&(r=P.modules.filter((function(e){return!e.ignored})).map((function(e){return e.moduleId})),!H.some((function(e){return r.includes(e.moduleId)})))})}G.only=function(){$||(P.modules.length=0,P.queue.length=0),z.apply(void 0,arguments),$=!0},G.skip=function(e,t,n){$||z(e,t,n,{skip:!0})},G.todo=function(e,t,n){$||z(e,t,n,{todo:!0})}
...
if(!t.stack)try{throw t}catch(e){t=e}return te(t,e)}function re(e){P.current?P.current.assert.pushResult({result:!1,message:"global failure: ".concat(L(e)),source:e&&e.stack||ne(2)}):(ze.globalFailureCount++,P.stats.bad++,P.stats.all++,J("error",e))}var ie,oe=0,se=[]
function ae(){var e
e=N(),P.depth=(P.depth||0)+1,ue(e),P.depth--,se.length||P.blocking||P.current||function(){if(!P.blocking&&!P.queue.length&&0===P.depth)return e=P.storage,t=N()-P.started,n=P.stats.all-P.stats.bad,le.finished=!0,0===P.stats.testCount&&!0===P.failOnZeroTests&&re(P.filter&&P.filter.length?new Error('No tests matched the filter "'.concat(P.filter,'".')):P.module&&P.module.length?new Error('No tests matched the module "'.concat(P.module,'".')):P.moduleId&&P.moduleId.length?new Error('No tests matched the moduleId "'.concat(P.moduleId,'".')):P.testId&&P.testId.length?new Error('No tests matched the testId "'.concat(P.testId,'".')):new Error("No tests were run.")),J("runEnd",ze.end(!0)),void X("done",{passed:n,failed:P.stats.bad,total:P.stats.all,runtime:t}).then((function(){if(e&&0===P.stats.bad)for(var t=e.length-1;t>=0;t--){var n=e.key(t)
0===n.indexOf("qunit-test-")&&e.removeItem(n)}}))
var e,t,n,r
r=P.queue.shift()(),se.push.apply(se,d(r)),oe>0&&oe--,ae()}()}function ue(e){if(se.length&&!P.blocking){var t=N()-e
if(!b||P.updateRate<=0||t<P.updateRate){var n=se.shift()
K.resolve(n()).then((function(){se.length?ue(e):ae()}))}else b(ae)}}var le={finished:!1,add:function(e,t,n){if(t)P.queue.splice(oe++,0,e)
else if(n){ie||(ie=function(e){var t=parseInt(O(e),16)||-1
return function(){return t^=t<<13,t^=t>>>17,(t^=t<<5)<0&&(t+=4294967296),t/4294967296}}(n))
var r=Math.floor(ie()*(P.queue.length-oe+1))
P.queue.splice(oe+r,0,e)}else P.queue.push(e)},advance:ae,taskCount:function(){return se.length}},ce=function(){function e(t,n,r){a(this,e),this.name=t,this.suiteName=n.name,this.fullName=n.fullName.concat(t),this.runtime=0,this.assertions=[],this.skipped=!!r.skip,this.todo=!!r.todo,this.valid=r.valid,this._startTime=0,this._endTime=0,n.pushTest(this)}return l(e,[{key:"start",value:function(e){return e&&(this._startTime=j.now(),j.mark("qunit_test_start")),{name:this.name,suiteName:this.suiteName,fullName:this.fullName.slice()}}},{key:"end",value:function(e){if(e&&(this._endTime=j.now(),j)){j.mark("qunit_test_end")
...
function de(e){if(this.expected=null,this.assertions=[],this.module=P.currentModule,this.steps=[],this.timeout=void 0,this.data=void 0,this.withData=!1,this.pauses=new o,this.nextPauseId=1,R(this,e),this.module.skip?(this.skip=!0,this.todo=!1):this.module.todo&&!this.skip&&(this.todo=!0),le.finished)E.warn("Unexpected test after runEnd. This is unstable and will fail in QUnit 3.0.")
else{if(!this.skip&&"function"!=typeof this.callback){var t=this.todo?"QUnit.todo":"QUnit.test"
throw new TypeError("You must provide a callback to ".concat(t,'("').concat(this.testName,'")'))}++de.count,this.errorForStack=new Error,this.testReport=new ce(this.testName,this.module.suiteReport,{todo:this.todo,skip:this.skip,valid:this.valid()})
for(var n=0,r=this.module.tests;n<r.length;n++)this.module.tests[n].name===this.testName&&(this.testName+=" ")
this.testId=O(this.module.name,this.testName),this.module.tests.push({name:this.testName,testId:this.testId,skip:!!this.skip}),this.skip?(this.callback=function(){},this.async=!1,this.expected=0):this.assert=new Ne(this)}}function fe(){if(!P.current)throw new Error("pushFailure() assertion outside test context, in "+ne(2))
var e=P.current
return e.pushFailure.apply(e,arguments)}function he(){if(P.pollution=[],P.noglobals)for(var e in p)if(C.call(p,e)){if(/^qunit-test-output/.test(e))continue
P.pollution.push(e)}}de.count=0,de.prototype={get stack(){return te(this.errorForStack,2)},before:function(){var e=this,t=this.module
return function(e){for(var t=e,n=[];t&&0===t.testsRun;)n.push(t),t=t.parentModule
return n.reverse()}(t).reduce((function(e,t){return e.then((function(){return t.stats={all:0,bad:0,started:N()},J("suiteStart",t.suiteReport.start(!0)),X("moduleStart",{name:t.name,tests:t.tests})}))}),K.resolve([])).then((function(){return P.current=e,e.testEnvironment=R({},t.testEnvironment),e.started=N(),J("testStart",e.testReport.start(!0)),X("testStart",{name:e.testName,module:t.name,testId:e.testId,previousFailure:e.previousFailure}).then((function(){P.pollution||he()}))}))},run:function(){if(P.current=this,this.callbackStarted=N(),P.notrycatch)e(this)
else try{e(this)}catch(e){this.pushFailure("Died on test #"+(this.assertions.length+1)+" "+this.stack+": "+(e.message||e),te(e,0)),he(),P.blocking&&we(this)}function e(e){var t
t=e.withData?e.callback.call(e.testEnvironment,e.assert,e.data):e.callback.call(e.testEnvironment,e.assert),e.resolvePromise(t),0===e.timeout&&e.pauses.size>0&&fe("Test did not finish synchronously even though assert.timeout( 0 ) was used.",ne(2))}},after:function(){!function(){var e=P.pollution
he()
...
r.preserveEnvironment=!0}if("after"!==t||function(e){return e.testsRun===Ee(e).filter((function(e){return!e.skip})).length-1}(n)||!(P.queue.length>0||le.taskCount()>2))if(P.current=r,P.notrycatch)i()
...
i?Ce(t):function(e){for(e.testsRun++;e=e.parentModule;)e.testsRun++}(t),a&&(s?a.setItem("qunit-test-"+n+"-"+r,s):a.removeItem("qunit-test-"+n+"-"+r)),J("testEnd",this.testReport.end(!0)),this.testReport.slimAssertions()
var l=this
return X("testDone",{name:r,module:n,skipped:i,todo:o,failed:s,passed:this.assertions.length-s,total:this.assertions.length,runtime:i?0:this.runtime,assertions:this.assertions,testId:this.testId,get source(){return l.stack}}).then((function(){if(Te(t)){for(var e=[t],n=t.parentModule;n&&Te(n);)e.push(n),n=n.parentModule
...
i&&(r.source=i)}this.logAssertion(r),this.assertions.push({result:!!e.result,message:e.message})},pushFailure:function(e,t,n){if(!(this instanceof de))throw new Error("pushFailure() assertion outside test context, was "+ne(2))
...
if("function"===_(r)){var i=ke(n),o=function(){i()}
P.notrycatch?r.call(e,o):r.call(e,o,(function(e){var r="Promise rejected "+(t?t.replace(/Each$/,""):"during")+' "'+n.testName+'": '+(e&&e.message||e)
n.pushFailure(r,te(e,0)),he(),we(n)}))}}},valid:function(){var e=P.filter,t=/^(!?)\/([\w\W]*)\/(i?$)/.exec(e),n=P.module&&P.module.toLowerCase(),r=this.module.name+": "+this.testName
return!(!this.callback||!this.callback.validTest)||!(P.moduleId&&P.moduleId.length>0&&!function e(t){return I(t.moduleId,P.moduleId)||t.parentModule&&e(t.parentModule)}(this.module))&&!(P.testId&&P.testId.length>0&&!I(this.testId,P.testId))&&!(n&&!function e(t){return(t.name?t.name.toLowerCase():null)===n||!!t.parentModule&&e(t.parentModule)}(this.module))&&(!e||(t?this.regexFilter(!!t[1],t[2],t[3],r):this.stringFilter(e,r)))},regexFilter:function(e,t,n,r){return new RegExp(t,n).test(r)!==e},stringFilter:function(e,t){e=e.toLowerCase(),t=t.toLowerCase()
var n="!"!==e.charAt(0)
return n||(e=e.slice(1)),-1!==t.indexOf(e)?n:!n}}
var pe=!1
function ge(e){pe||P.currentModule.ignored||new de(e).queue()}function me(e){P.currentModule.ignored||(pe||(P.queue.length=0,pe=!0),new de(e).queue())}function ve(e,t){ge({testName:e,callback:t})}function be(e,t){return"".concat(e," [").concat(t,"]")}function ye(e,t){if(Array.isArray(e))e.forEach(t)
else{if("object"!==s(e)||null===e)throw new Error("test.each() expects an array or object as input, but\nfound ".concat(s(e)," instead."))
Object.keys(e).forEach((function(n){t(e[n],n)}))}}function ke(e){var t=arguments.length>1&&void 0!==arguments[1]?arguments[1]:1
P.blocking=!0
...
i.remaining--,0===i.remaining&&e.pauses.delete(r),xe(e)}}return e.pauses.set(r,i),b&&("number"==typeof e.timeout?n=e.timeout:"number"==typeof P.testTimeout&&(n=P.testTimeout),"number"==typeof n&&n>0&&(P.timeoutHandler=function(t){return function(){P.timeout=null,i.cancelled=!0,e.pauses.delete(r),e.pushFailure("Test took longer than ".concat(t,"ms; test timed out."),ne(2)),xe(e)}},y(P.timeout),P.timeout=b(P.timeoutHandler(n),n))),o}function we(e){e.pauses.forEach((function(e){e.cancelled=!0})),e.pauses.clear(),xe(e)}function xe(e){e.pauses.size>0||(b?(y(P.timeout),P.timeout=b((function(){e.pauses.size>0||(y(P.timeout),P.timeout=null,Je())}))):Je())}function Ee(e){for(var t=[].concat(e.tests),n=d(e.childModules);n.length;){var r=n.shift()
t.push.apply(t,r.tests),n.push.apply(n,d(r.childModules))}return t}function Te(e){return e.testsRun+e.testsIgnored===Ee(e).length}function Ce(e){for(e.testsIgnored++;e=e.parentModule;)e.testsIgnored++}R(ve,{todo:function(e,t){ge({testName:e,callback:t,todo:!0})},skip:function(e){ge({testName:e,skip:!0})},only:function(e,t){me({testName:e,callback:t})},each:function(e,t,n){ye(t,(function(t,r){ge({testName:be(e,r),callback:n,withData:!0,data:t})}))}}),ve.todo.each=function(e,t,n){ye(t,(function(t,r){ge({testName:be(e,r),callback:n,todo:!0,withData:!0,data:t})}))},ve.skip.each=function(e,t){ye(t,(function(t,n){ge({testName:be(e,n),skip:!0})}))},ve.only.each=function(e,t,n){ye(t,(function(t,r){me({testName:be(e,r),callback:n,withData:!0,data:t})}))}
var Ne=function(){function e(t){a(this,e),this.test=t}return l(e,[{key:"timeout",value:function(e){if("number"!=typeof e)throw new Error("You must pass a number as the duration to assert.timeout")
var t
...
this.pushResult({result:r,actual:e,expected:t,message:n,negative:!0})}},{key:"propEqual",value:function(e,t,n){e=M(e),t=M(t),this.pushResult({result:U(e,t),actual:e,expected:t,message:n})}},{key:"notPropEqual",value:function(e,t,n){e=M(e),t=M(t),this.pushResult({result:!U(e,t),actual:e,expected:t,message:n,negative:!0})}},{key:"deepEqual",value:function(e,t,n){this.pushResult({result:U(e,t),actual:e,expected:t,message:n})}},{key:"notDeepEqual",value:function(e,t,n){this.pushResult({result:!U(e,t),actual:e,expected:t,message:n,negative:!0})}},{key:"strictEqual",value:function(e,t,n){this.pushResult({result:t===e,actual:e,expected:t,message:n})}},{key:"notStrictEqual",value:function(e,t,n){this.pushResult({result:t!==e,actual:e,expected:t,message:n,negative:!0})}},{key:"throws",value:function(t,n,r){var i=c(Se(n,r,"throws"),2)
n=i[0],r=i[1]
var o=this instanceof e&&this.test||P.current
if("function"===_(t)){var s,a=!1
o.ignoreGlobalErrors=!0
try{t.call(o.testEnvironment)}catch(e){s=e}if(o.ignoreGlobalErrors=!1,s){var u=c(je(s,n,r),3)
...
o.assert.pushResult({result:!1,actual:t,message:l})}}},{key:"rejects",value:function(t,n,r){var i=c(Se(n,r,"rejects"),2)
n=i[0],r=i[1]
...
o.assert.pushResult({result:!1,message:e,actual:t}),a()}),(function(e){var t,i=c(je(e,n,r),3)
...
return[e,t]}function je(e,t,n){var r=!1,i=_(t)
...
var qe,Ie,Me,Re,_e=function(){function e(t){var n=arguments.length>1&&void 0!==arguments[1]?arguments[1]:{}
...
qe=Oe.FORCE_COLOR,Ie=Oe.NODE_DISABLE_COLORS,Me=Oe.NO_COLOR,Re=Oe.TERM,Ae=process.stdout&&process.stdout.isTTY}var Le={enabled:!Ie&&null==Me&&"dumb"!==Re&&(null!=qe&&"0"!==qe||Ae),reset:Pe(0,0),bold:Pe(1,22),dim:Pe(2,22),italic:Pe(3,23),underline:Pe(4,24),inverse:Pe(7,27),hidden:Pe(8,28),strikethrough:Pe(9,29),black:Pe(30,39),red:Pe(31,39),green:Pe(32,39),yellow:Pe(33,39),blue:Pe(34,39),magenta:Pe(35,39),cyan:Pe(36,39),white:Pe(37,39),gray:Pe(90,39),grey:Pe(90,39),bgBlack:Pe(40,49),bgRed:Pe(41,49),bgGreen:Pe(42,49),bgYellow:Pe(43,49),bgBlue:Pe(44,49),bgMagenta:Pe(45,49),bgCyan:Pe(46,49),bgWhite:Pe(47,49)}
function Ue(e,t){for(var n,r=0,i="",o="";r<e.length;r++)i+=(n=e[r]).open,o+=n.close,~t.indexOf(n.close)&&(t=t.replace(n.rgx,n.close+n.open))
return i+t+o}function Pe(e,t){var n={open:"[".concat(e,"m"),close:"[".concat(t,"m"),rgx:new RegExp("\\x1b\\[".concat(t,"m"),"g")}
return function(t){return void 0!==this&&void 0!==this.has?(~this.has.indexOf(e)||(this.has.push(e),this.keys.push(n)),void 0===t?this:Le.enabled?Ue(this.keys,t+""):t+""):void 0===t?((r={has:[e],keys:[n]}).reset=Le.reset.bind(r),r.bold=Le.bold.bind(r),r.dim=Le.dim.bind(r),r.italic=Le.italic.bind(r),r.underline=Le.underline.bind(r),r.inverse=Le.inverse.bind(r),r.hidden=Le.hidden.bind(r),r.strikethrough=Le.strikethrough.bind(r),r.black=Le.black.bind(r),r.red=Le.red.bind(r),r.green=Le.green.bind(r),r.yellow=Le.yellow.bind(r),r.blue=Le.blue.bind(r),r.magenta=Le.magenta.bind(r),r.cyan=Le.cyan.bind(r),r.white=Le.white.bind(r),r.gray=Le.gray.bind(r),r.grey=Le.grey.bind(r),r.bgBlack=Le.bgBlack.bind(r),r.bgRed=Le.bgRed.bind(r),r.bgGreen=Le.bgGreen.bind(r),r.bgYellow=Le.bgYellow.bind(r),r.bgBlue=Le.bgBlue.bind(r),r.bgMagenta=Le.bgMagenta.bind(r),r.bgCyan=Le.bgCyan.bind(r),r.bgWhite=Le.bgWhite.bind(r),r):Le.enabled?Ue([n],t+""):t+""
...
break
default:t=e}return t}var He={console:_e,tap:function(){function e(t){var n=arguments.length>1&&void 0!==arguments[1]?arguments[1]:{}
...
n+="\n  message: ".concat(Fe(e.message||"failed")),n+="\n  severity: ".concat(Fe(t||"failed")),De.call(e,"actual")&&(n+="\n  actual  : ".concat(Fe(e.actual))),De.call(e,"expected")&&(n+="\n  expected: ".concat(Fe(e.expected))),e.stack&&(n+="\n  stack: ".concat(Fe(e.stack+"\n"))),n+="\n  ...",this.log(n)}},{key:"logError",value:function(e){var t="  ---"
t+="\n  message: ".concat(Fe(L(e))),t+="\n  severity: ".concat(Fe("failed")),e&&e.stack&&(t+="\n  stack: ".concat(Fe(e.stack+"\n"))),t+="\n  ...",this.log(t)}}],[{key:"init",value:function(t,n){return new e(t,n)}}]),e}()},Qe={},ze=new B
P.currentModule.suiteReport=ze
var $e=!1,Ge=!1
...
return t.stack=e.stacktrace||e.fileName+":"+e.lineNumber,re(t),!1},onUncaughtException:re,pushFailure:fe,assert:Ne.prototype,module:G,test:ve,todo:ve.todo,skip:ve.skip,only:ve.only,start:function(e){if(P.current)throw new Error("QUnit.start cannot be called inside a test context.")
var t=$e
if($e=!0,Ge)throw new Error("Called start() while test already started running")
...
if(!P.pageLoaded)return P.autostart=!0,void(k||Qe.load())
Ye()},onUnhandledRejection:function(e){E.warn("QUnit.onUnhandledRejection is deprecated and will be removed in QUnit 3.0. Please use QUnit.onUncaughtException instead."),re(e)},extend:function(){E.warn("QUnit.extend is deprecated and will be removed in QUnit 3.0. Please use Object.assign instead.")
for(var e=arguments.length,t=new Array(e),n=0;n<e;n++)t[n]=arguments[n]
return R.apply(this,t)},load:function(){P.pageLoaded=!0,R(P,{started:0,updateRate:1e3,autostart:!0,filter:""},!0),Ge||(P.blocking=!1,P.autostart&&Ye())},stack:function(e){return ne(e=(e||0)+2)}}),function(e){var t=["begin","done","log","testStart","testDone","moduleStart","moduleDone"]
...
"undefined"===_(P.callbacks[o])&&(P.callbacks[o]=[]),e[o]=n(o)}}(Qe),function(i){var o=!1
...
var s=Date.now()
if(i&&i.keys)for(var f=i.scoreFn||l,E=i.keys,T=E.length;m>=0;--m){for(var C=n[m],N=new Array(T),S=T-1;S>=0;--S)(I=c(C,q=E[S]))?(d(I)||(I=p.getPrepared(I)),N[S]=y(t,I,h)):N[S]=null
N.obj=C
var j=f(N)
if(null!==j&&!(j<v)&&(N.score=j,k<b?(g.add(N),++k):(++w,j>g.peek().score&&g.replaceTop(N)),m%1e3==0&&Date.now()-s>=10))return void(e?setImmediate(x):setTimeout(x))}else if(i&&i.key){for(var q=i.key;m>=0;--m)if((I=c(C=n[m],q))&&(d(I)||(I=p.getPrepared(I)),null!==(M=y(t,I,h))&&!(M.score<v)&&(M={target:M.target,_targetLowerCodes:null,_nextBeginningIndexes:null,score:M.score,indexes:M.indexes,obj:C},k<b?(g.add(M),++k):(++w,M.score>g.peek().score&&g.replaceTop(M)),m%1e3==0&&Date.now()-s>=10)))return void(e?setImmediate(x):setTimeout(x))}else for(;m>=0;--m){var I,M
if((I=n[m])&&(d(I)||(I=p.getPrepared(I)),null!==(M=y(t,I,h))&&!(M.score<v)&&(k<b?(g.add(M),++k):(++w,M.score>g.peek().score&&g.replaceTop(M)),m%1e3==0&&Date.now()-s>=10)))return void(e?setImmediate(x):setTimeout(x))}if(0===k)return a(r)
...
case"<":return"&lt;"
case">":return"&gt;"
case"&":return"&amp;"}})):""}!function(){if(g&&k){var e=Qe.config,t=[],n=!1,r=Object.prototype.hasOwnProperty,i=N({filter:void 0,module:void 0,moduleId:void 0,testId:void 0})
Qe.on("runStart",(function(t){var n,o,s,a,u,f,h,v,E,N,q
Ke.defined=t.testCounts.total,(f=y("qunit"))&&(f.setAttribute("role","main"),f.innerHTML="<h1 id='qunit-header'>"+Xe(k.title)+"</h1><h2 id='qunit-banner'></h2><div id='qunit-testrunner-toolbar' role='navigation'></div>"+(!(n=Qe.config.testId)||n.length<=0?"":"<div id='qunit-filteredTest'>Rerunning selected tests: "+Xe(n.join(", "))+" <a id='qunit-clearFilter' href='"+Xe(i)+"'>Run all tests</a></div>")+"<h2 id='qunit-userAgent'></h2><ol id='qunit-tests'></ol>"),(o=y("qunit-header"))&&(o.innerHTML="<a href='"+Xe(i)+"'>"+o.innerHTML+"</a> "),(s=y("qunit-banner"))&&(s.className=""),N=y("qunit-tests"),(q=y("qunit-testresult"))&&q.parentNode.removeChild(q),N&&(N.innerHTML="",(q=k.createElement("p")).id="qunit-testresult",q.className="result",N.parentNode.insertBefore(q,N),q.innerHTML='<div id="qunit-testresult-display">Running...<br />&#160;</div><div id="qunit-testresult-controls"></div><div class="clearfix"></div>',v=y("qunit-testresult-controls")),v&&v.appendChild(((E=k.createElement("button")).id="qunit-abort-tests-button",E.innerHTML="Abort",l(E,"click",x),E)),(a=y("qunit-userAgent"))&&(a.innerHTML="",a.appendChild(k.createTextNode("QUnit "+Qe.version+"; "+w.userAgent))),(u=y("qunit-testrunner-toolbar"))&&(u.appendChild(((h=k.createElement("span")).innerHTML=function(){var t,n,i,o,s,a=!1,u=e.urlConfig,l=""
...
return l}(),p(h,"qunit-url-config"),d(h.getElementsByTagName("input"),"change",C),d(h.getElementsByTagName("select"),"change",C),h)),u.appendChild(function(){var t,n,r,i,o=k.createElement("span")
return o.id="qunit-toolbar-filters",o.appendChild((t=k.createElement("form"),n=k.createElement("label"),r=k.createElement("input"),i=k.createElement("button"),p(t,"qunit-filter"),n.innerHTML="Filter: ",r.type="text",r.value=e.filter||"",r.name="filter",r.id="qunit-filter-input",i.innerHTML="Go",n.appendChild(r),t.appendChild(n),t.appendChild(k.createTextNode(" ")),t.appendChild(i),l(t,"submit",T),t)),o.appendChild(function(){var t,n,r,i=k.createElement("form"),o=k.createElement("label"),s=k.createElement("input"),a=k.createElement("div"),u=k.createElement("span"),d=k.createElement("button"),f=k.createElement("button"),h=k.createElement("label"),p=k.createElement("input"),v=k.createElement("ul"),y=!1
...
v.innerHTML=j(n)}),200)}function E(e){var r,i,o=e&&e.target||p,a=v.getElementsByTagName("input"),u=[]
...
t.style.display=n.style.display=y?"":"none",s.placeholder=u.join(", ")||p.parentNode.textContent,s.title="Type to filter list. Current selection:\n"+(u.join("\n")||p.parentNode.textContent)}return s.id="qunit-modulefilter-search",s.autocomplete="off",l(s,"input",x),l(s,"input",w),l(s,"focus",w),l(s,"click",w),e.modules.forEach((function(e){return e.namePrepared=Ze.prepare(e.name)})),o.id="qunit-modulefilter-search-container",o.innerHTML="Module: ",o.appendChild(s),d.textContent="Apply",d.style.display="none",f.textContent="Reset",f.type="reset",f.style.display="none",p.type="checkbox",p.checked=0===e.moduleId.length,h.className="clickable",e.moduleId.length&&(h.className="checked"),h.appendChild(p),h.appendChild(k.createTextNode("All modules")),u.id="qunit-modulefilter-actions",u.appendChild(d),u.appendChild(f),u.appendChild(h),t=u.firstChild,n=t.nextSibling,l(t,"click",S),v.id="qunit-modulefilter-dropdown-list",v.innerHTML=j(e.modules),a.id="qunit-modulefilter-dropdown",a.style.display="none",a.appendChild(u),a.appendChild(v),l(a,"change",E),E(),i.id="qunit-modulefilter",i.appendChild(o),i.appendChild(a),l(i,"submit",T),l(i,"reset",(function(){g.setTimeout(E)})),i}()),o}()),u.appendChild(k.createElement("div")).className="clearfix")})),Qe.on("runEnd",(function(t){var n,r,i,o=y("qunit-banner"),s=y("qunit-tests"),a=y("qunit-abort-tests-button"),u=e.stats.all-e.stats.bad,l=[t.testCounts.total," tests completed in ",t.runtime," milliseconds, with ",t.testCounts.failed," failed, ",t.testCounts.skipped," skipped, and ",t.testCounts.todo," todo.<br />","<span class='passed'>",u,"</span> assertions of <span class='total'>",e.stats.all,"</span> passed, <span class='failed'>",e.stats.bad,"</span> failed.",I(Ke.failedTests)].join("")
...
q(e.name,e.testId,e.module),(t=y("qunit-testresult-display"))&&(p(t,"running"),n=Qe.config.reorder&&e.previousFailure,t.innerHTML=[_(Ke),n?"Rerunning previously failed test: <br />":"Running: ",M(e.name,e.module),I(Ke.failedTests)].join(""))})),Qe.log((function(e){var t,n,i,o,s,a,u=!1,l=y("qunit-test-output-"+e.testId)
l&&(i="<span class='test-message'>"+(i=Xe(e.message)||(e.result?"okay":"failed"))+"</span>",i+="<span class='runtime'>@ "+e.runtime+" ms</span>",!e.result&&r.call(e,"expected")?(o=e.negative?"NOT "+Qe.dump.parse(e.expected):Qe.dump.parse(e.expected),s=Qe.dump.parse(e.actual),i+="<table><tr class='test-expected'><th>Expected: </th><td><pre>"+Xe(o)+"</pre></td></tr>",s!==o?(i+="<tr class='test-actual'><th>Result: </th><td><pre>"+Xe(s)+"</pre></td></tr>","number"==typeof e.actual&&"number"==typeof e.expected?isNaN(e.actual)||isNaN(e.expected)||(u=!0,a=((a=e.actual-e.expected)>0?"+":"")+a):"boolean"!=typeof e.actual&&"boolean"!=typeof e.expected&&(u=A(a=Qe.diff(o,s)).length!==A(o).length+A(s).length),u&&(i+="<tr class='test-diff'><th>Diff: </th><td><pre>"+a+"</pre></td></tr>")):-1!==o.indexOf("[object Array]")||-1!==o.indexOf("[object Object]")?i+="<tr class='test-message'><th>Message: </th><td>Diff suppressed as the depth of object is more than current max depth ("+Qe.config.maxDepth+").<p>Hint: Use <code>QUnit.dump.maxDepth</code> to  run with a higher max depth or <a href='"+Xe(N({maxDepth:-1}))+"'>Rerun</a> without max depth.</p></td></tr>":i+="<tr class='test-message'><th>Message: </th><td>Diff suppressed as the expected and actual results have an equivalent serialization</td></tr>",e.source&&(i+="<tr class='test-source'><th>Source: </th><td><pre>"+Xe(e.source)+"</pre></td></tr>"),i+="</table>"):!e.result&&e.source&&(i+="<table><tr class='test-source'><th>Source: </th><td><pre>"+Xe(e.source)+"</pre></td></tr></table>"),t=l.getElementsByTagName("ol")[0],(n=k.createElement("li")).className=e.result?"pass":"fail",n.innerHTML=i,t.appendChild(n))})),Qe.testDone((function(r){var i,o,s,a,u,c,d,f,h,g=y("qunit-tests"),v=y("qunit-test-output-"+r.testId)
...
var d=o||new Error(t)
!d.stack&&n&&r&&(d.stack="".concat(n,":").concat(r)),Qe.onUncaughtException(d)}return s},g.addEventListener("unhandledrejection",(function(e){Qe.onUncaughtException(e.reason)}))}function u(e){return"function"==typeof e.trim?e.trim():e.replace(/^\s+|\s+$/g,"")}function l(e,t,n){e.addEventListener(t,n,!1)}function c(e,t,n){e.removeEventListener(t,n,!1)}function d(e,t,n){for(var r=e.length;r--;)l(e[r],t,n)}function h(e,t){return(" "+e.className+" ").indexOf(" "+t+" ")>=0}function p(e,t){h(e,t)||(e.className+=(e.className?" ":"")+t)}function m(e,t,n){n||void 0===n&&!h(e,t)?p(e,t):b(e,t)}function b(e,t){for(var n=" "+e.className+" ";n.indexOf(" "+t+" ")>=0;)n=n.replace(" "+t+" "," ")
e.className=u(n)}function y(e){return k.getElementById&&k.getElementById(e)}function x(){var e=y("qunit-abort-tests-button")
return e&&(e.disabled=!0,e.innerHTML="Aborting..."),Qe.config.queue.length=0,!1}function T(e){var t=y("qunit-filter-input")
return t.value=u(t.value),S(),e&&e.preventDefault&&e.preventDefault(),!1}function C(){var n,r,i,o=this,s={}
if(r="selectedIndex"in o?o.options[o.selectedIndex].value||void 0:o.checked?o.defaultValue||!0:void 0,s[o.name]=r,n=N(s),"hidepassed"===o.name&&"replaceState"in g.history){if(Qe.urlParams[o.name]=r,e[o.name]=r||!1,i=y("qunit-tests")){var a=i.children.length,u=i.children
...
i.removeChild(b)}}catch(e){v.e(e)}finally{v.f()}}else for(;null!=(c=t.pop());)i.appendChild(c)}g.history.replaceState(null,"",n)}else g.location=n}function N(e){var t,n,i,o="?",s=g.location
for(t in e=R(R({},Qe.urlParams),e))if(r.call(e,t)&&void 0!==e[t])for(n=[].concat(e[t]),i=0;i<n.length;i++)o+=encodeURIComponent(t),!0!==n[i]&&(o+="="+encodeURIComponent(n[i])),o+="&"
return s.protocol+"//"+s.host+s.pathname+o.slice(0,-1)}function S(){var e,t=[],n=y("qunit-modulefilter-dropdown-list").getElementsByTagName("input"),r=y("qunit-filter-input").value
for(e=0;e<n.length;e++)n[e].checked&&t.push(n[e].value)
g.location=N({filter:""===r?void 0:r,moduleId:0===t.length?void 0:t,module:void 0,testId:void 0})}function j(t){var n,r,i=""
...
if(a)return(r=k.createElement("strong")).innerHTML=M(e,n),(o=k.createElement("li")).appendChild(r),void 0!==t&&((i=k.createElement("a")).innerHTML="Rerun",i.href=N({testId:t}),o.id="qunit-test-output-"+t,o.appendChild(i)),(s=k.createElement("ol")).className="qunit-assert-list",o.appendChild(s),a.appendChild(o),o}function I(e){return 0===e.length?"":["<br /><a href='"+Xe(N({testId:e}))+"'>",1===e.length?"Rerun 1 failed test":"Rerun "+e.length+" failed tests","</a>"].join("")}function M(e,t){var n=""
return t&&(n="<span class='module-name'>"+Xe(t)+"</span>: "),n+"<span class='test-name'>"+Xe(e)+"</span>"}function _(e){return[e.completed," / ",e.defined," tests completed.<br />"].join("")}function A(e){return e.replace(/<\/?[^>]+(>|$)/g,"").replace(/&quot;/g,"").replace(/\s+/g,"")}}(),Qe.diff=function(){function e(){}var t=-1,n=Object.prototype.hasOwnProperty
