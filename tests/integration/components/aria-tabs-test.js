...
function createTabs() {
  return render(hbs`<AriaTabs as |at|>
  <at.tabList as |tl|>
    <tl.tab>Foo</tl.tab>
    <tl.tab>Bar</tl.tab>
    <tl.tab>
...
module('Integration | Component | aria-tabs', function (hooks) {
  ...
  test('it renders with positive defaultIndex prop', async function (assert) {
    await render(hbs`<AriaTabs @defaultIndex={{1}} as |at|>
  <at.tabList as |tl|>
    <tl.tab>Foo</tl.tab>
    <tl.tab>Bar</tl.tab>
    <tl.tab>
  ...
  test('it calls onSelect when selection changes', async function (assert) {
    ...
    await render(hbs`<AriaTabs @onSelect={{this.onSelect}} as |at|>
  <at.tabList as |tl|>
    <tl.tab>Foo</tl.tab>
    <tl.tab>Bar</tl.tab>
    <tl.tab>
  ...
  test('it renders with class names', async function (assert) {
    await render(hbs`<AriaTabs class='foobar' as |at|>
  <at.tabList as |tl|>
    <tl.tab>Foo</tl.tab>
    <tl.tab>Bar</tl.tab>
    <tl.tab>
  ...
  test('it updates selectedIndex when tab child is clicked', async function (assert) {
    assert.expect(2);
    await render(hbs`<AriaTabs as |at|>
  <at.tabList as |tl|>
    <tl.tab>Foo</tl.tab>
    <tl.tab>Bar</tl.tab>
    <tl.tab>
  ...
  test('it yield selected state', async function (assert) {
    await render(hbs`<AriaTabs @forceRenderTabPanel={{true}} as |at|>
  <at.tabList as |tl|>
...
>
  ...
  test('it supports nested tabs', async function (assert) {
    await render(hbs`<AriaTabs class='first' as |at|>
  <at.tabList as |tl|>
    <tl.tab>Foo</tl.tab>
    <tl.tab>Bar</tl.tab>
  </at.tabList>
  ...
  test('it handles dynamic tabs', async function (assert) {
    ...
    await render(hbs`<button data-test-remove-tab type='button' {{on 'click' this.removeTab}}>Remove
  tab</button>
<AriaTabs as |at|>
  <at.tabList as |tl|>
    {{#unless this.removed}}
  ...
  test('it handles complex layout', async function (assert) {
    ...
    await render(hbs`<AriaTabs @forceRenderTabPanel={{true}} @defaultIndex={{1}} as |at|>
  <at.tabList as |tl|>
